...
public class BrickD extends Brick {
    ...
    BrickD(int x, int y) {
        ...
        brick[1] = new Tile(x + 35, y, color);
        brick[2] = new Tile(x + 35, y + 35, color);
        brick[3] = new Tile(x + 70, y + 35, color);
        current = true;
        rotatePhase = 1;
        rotate = false;
    }
        ...
        if (rotate) {
            if (rotatePhase == 1) {
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    brick[i + 2].setX(tempX);
                    brick[i + 2].setY(tempY + (35 * i));
                }
                checkBounds();
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    brick[i].setY(tempY);
                    brick[i + 2].setX(tempX + (35 * i));
                    brick[i + 2].setY(tempY + 35);
                }
                checkBounds();
